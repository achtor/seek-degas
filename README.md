...
This is a simple library for scraping the SEC's EDGAR resource. Companies like <a href="http://seekinf.com">seekinf</a> charge for full access to the data, despite it being free on their FTP server.
